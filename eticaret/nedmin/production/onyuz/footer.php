        ...
        <div class="row">
            ...
            <div class="col-md-4"><!--footer contact widget-->
                ...
                <ul class="contact-widget">
                    <li class="fphone"> <?php echo $ayarcek['phone'];?> <br> <?php echo $ayarcek['faks'];?></li>
                    <li class="fmobile"><?php echo $ayarcek['gsm'];?><br><?php echo $ayarcek['gsm'];?></li>
                    <li class="fmail lastone"><?php echo $ayarcek['gsm'];?><br><?php echo $ayarcek['gsm'];?></li>
                </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="f-credit">&copy; <?php echo $ayarcek['author']?><a href="http://222.joyakademi.com"> http://joyakademi.com</a></div>
            ...
            <div class="col-md-3"><!--footer Share-->
                ...
                <div class="fsoc">
                    <a href= "http://<?php echo $ayarcek['facebook'];?>" class="ffacebook">facebook</a>
                    <a href="http://<?php echo $ayarcek['twitter'];?>" class="ftwitter">twitter</a>
                    <a href="http://<?php echo $ayarcek['youtube'];?>" class="fflickr">youtube</a>
                    <a href="http://<?php echo $ayarcek['google'];?>" class="ffeed">google</a>
